...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WidgetFormat'
        db.create_table(u'website_widgetformat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('is_enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'website', ['WidgetFormat'])


    def backwards(self, orm):
        # Deleting model 'WidgetFormat'
        db.delete_table(u'website_widgetformat')
