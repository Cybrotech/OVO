...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Website.page_views_per_month'
        db.alter_column(u'website_website', 'page_views_per_month', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Website.unique_users_per_day'
        db.alter_column(u'website_website', 'unique_users_per_day', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Website.page_views_per_day'
        db.alter_column(u'website_website', 'page_views_per_day', self.gf('django.db.models.fields.BigIntegerField')())

        # Changing field 'Website.unique_users_per_month'
        db.alter_column(u'website_website', 'unique_users_per_month', self.gf('django.db.models.fields.BigIntegerField')())

    def backwards(self, orm):

        # Changing field 'Website.page_views_per_month'
        db.alter_column(u'website_website', 'page_views_per_month', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Website.unique_users_per_day'
        db.alter_column(u'website_website', 'unique_users_per_day', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Website.page_views_per_day'
        db.alter_column(u'website_website', 'page_views_per_day', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Website.unique_users_per_month'
        db.alter_column(u'website_website', 'unique_users_per_month', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        u'website.website': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'page_views_per_day': ('django.db.models.fields.BigIntegerField', [], {}),
            'page_views_per_month': ('django.db.models.fields.BigIntegerField', [], {}),
            'site_name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'unique_users_per_day': ('django.db.models.fields.BigIntegerField', [], {}),
            'unique_users_per_month': ('django.db.models.fields.BigIntegerField', [], {}),
            'url': ('django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '200'}),
        ...
        u'website.widgetformatchoice': {
            'Meta': {'object_name': 'WidgetFormatChoice'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'size': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'widget_format_choice'", 'to': u"orm['my_user.CustomUser']"}),
            'widget_format': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'widget_format_choice'", 'to': u"orm['website.WidgetFormat']"})
        }
    }
