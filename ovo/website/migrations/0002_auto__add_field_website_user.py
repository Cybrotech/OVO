...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Website.user'
        db.add_column(u'website_website', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='websites', null=True, to=orm['my_user.CustomUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Website.user'
        db.delete_column(u'website_website', 'user_id')
