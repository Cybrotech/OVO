...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field allowed_clips on 'Section'
        m2m_table_name = db.shorten_name(u'website_section_allowed_clips')
        ...
        db.create_unique(m2m_table_name, ['section_id', 'video_id'])


    def backwards(self, orm):
        # Removing M2M table for field allowed_clips on 'Section'
        db.delete_table(db.shorten_name(u'website_section_allowed_clips'))
