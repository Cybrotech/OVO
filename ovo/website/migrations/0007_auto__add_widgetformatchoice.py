...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WidgetFormatChoice'
        db.create_table(u'website_widgetformatchoice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='widget_format_choice', to=orm['my_user.CustomUser'])),
            ('widget_format', self.gf('django.db.models.fields.related.ForeignKey')(related_name='widget_format_choice', to=orm['website.WidgetFormat'])),
        ))
        db.send_create_signal(u'website', ['WidgetFormatChoice'])


    def backwards(self, orm):
        # Deleting model 'WidgetFormatChoice'
        db.delete_table(u'website_widgetformatchoice')
