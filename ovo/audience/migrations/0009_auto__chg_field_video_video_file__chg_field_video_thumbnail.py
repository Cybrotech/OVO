...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.video_file'
        db.alter_column(u'audience_video', 'video_file', self.gf('django.db.models.fields.files.FileField')(max_length=250, null=True))

        # Changing field 'Video.thumbnail'
        db.alter_column(u'audience_video', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Video.video_file'
        db.alter_column(u'audience_video', 'video_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'Video.thumbnail'
        db.alter_column(u'audience_video', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
