...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'audience_country', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('country', self.gf('django_countries.fields.CountryField')(max_length=2)),
        ))
        db.send_create_signal(u'audience', ['Country'])

        # Adding M2M table for field blacklisted_country on 'Video'
        m2m_table_name = db.shorten_name(u'audience_video_blacklisted_country')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('video', models.ForeignKey(orm[u'audience.video'], null=False)),
            ('country', models.ForeignKey(orm[u'audience.country'], null=False))
        ))
        db.create_unique(m2m_table_name, ['video_id', 'country_id'])
