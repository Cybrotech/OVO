...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Video.collection'
        db.alter_column(u'audience_video', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audience.Collection'], null=True))

    def backwards(self, orm):

        # Changing field 'Video.collection'
        db.alter_column(u'audience_video', 'collection_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['audience.Collection']))
