...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Collection.topic'
        db.alter_column(u'audience_collection', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['audience.Topic'], null=True))

    def backwards(self, orm):

        # Changing field 'Collection.topic'
        db.alter_column(u'audience_collection', 'topic_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['audience.Topic']))
