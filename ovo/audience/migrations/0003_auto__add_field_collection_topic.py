...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Collection.topic'
        db.add_column(u'audience_collection', 'topic',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['audience.Topic']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Collection.topic'
        db.delete_column(u'audience_collection', 'topic_id')
    ...
    models = {
        u'audience.collection': {
            ...
            'topic': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['audience.Topic']"}),
