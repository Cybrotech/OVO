...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'audience_country', 'country')

        # Adding field 'Country.name'
        db.add_column(u'audience_country', 'name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Country.code'
        db.add_column(u'audience_country', 'code',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'audience_country', 'country',
                      self.gf('django_countries.fields.CountryField')(default=2, max_length=2),
                      keep_default=False)

        # Deleting field 'Country.name'
        db.delete_column(u'audience_country', 'name')

        # Deleting field 'Country.code'
        db.delete_column(u'audience_country', 'code')
